...
CREATE TABLE `black_page` (
  `wiki` varchar(20) NOT NULL DEFAULT 'zhwiki',
...
CREATE TABLE `RC_log_abusefilter_hit` (
  `bot` tinyint(1) NOT NULL,
  `comment` varchar(1000) NOT NULL,
  `log_action_comment` varchar(1000) NOT NULL,
  `log_id` int(11) NOT NULL,
  `log_params_action` varchar(10) NOT NULL,
  `log_params_actions` varchar(30) NOT NULL,
...
CREATE TABLE `RC_log_block` (
  ...
  `comment` varchar(1000) NOT NULL,
  `id` int(11) NOT NULL,
  `log_action` varchar(15) NOT NULL,
  `log_action_comment` varchar(1000) NOT NULL,
  `log_id` int(11) NOT NULL,
  `log_params_flags` varchar(50) NOT NULL,
  `log_params_duration` varchar(20) NOT NULL,
  `namespace` int(11) NOT NULL,
  `parsedcomment` text NOT NULL,
  `timestamp` int(11) NOT NULL,
  `title` varchar(255) NOT NULL,
...
CREATE TABLE `RC_log_delete_revision` (
  ...
  `log_action_comment` varchar(1000) NOT NULL,
  `log_id` int(11) NOT NULL,
  `log_params_ids` text NOT NULL,
  `log_params_type` varchar(30) NOT NULL,
...
CREATE TABLE `RC_log_merge` (
  ...
  `log_action_comment` varchar(1000) NOT NULL,
  `log_id` int(11) NOT NULL,
  `log_params_dest` varchar(255) NOT NULL,
...
CREATE TABLE `RC_log_move` (
  ...
  `log_params_target` varchar(255) NOT NULL,
  `namespace` int(11) NOT NULL,
  `parsedcomment` text NOT NULL,
  `timestamp` int(11) NOT NULL,
  `title` varchar(255) NOT NULL,
...
CREATE TABLE `RC_log_protect` (
  ...
  `log_action_comment` varchar(1000) NOT NULL,
  `log_id` int(11) NOT NULL,
  `log_params_details` varchar(1000) NOT NULL,
  `log_params_description` varchar(255) NOT NULL,
...
CREATE TABLE `RC_log_rights` (
  ...
  `log_action_comment` varchar(1000) NOT NULL,
  `log_id` int(11) NOT NULL,
  `log_params_newgroups` varchar(1000) NOT NULL,
  `log_params_oldgroups` varchar(1000) NOT NULL,
  `log_params_newmetadata` varchar(1000) NOT NULL,
  `log_params_oldmetadata` varchar(1000) NOT NULL,
  `namespace` int(11) NOT NULL,
  `parsedcomment` text NOT NULL,
  `timestamp` int(11) NOT NULL,
  `title` varchar(255) NOT NULL,
...
CREATE TABLE `RC_log_upload` (
  ...
  `log_params_img_sha1` varchar(50) NOT NULL,
  `namespace` int(11) NOT NULL,
  `parsedcomment` text NOT NULL,
  `timestamp` int(11) NOT NULL,
  `title` varchar(255) NOT NULL,
